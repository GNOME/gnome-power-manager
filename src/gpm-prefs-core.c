 ...
 * @widget: The GtkWidget object
 * @icon_policy: The policy for displaying an icon, e.g. "always"
 **/
static void
			    ...
			    gpointer	 user_data)
{
	...
	gpm_debug ("GConf key changed %s", entry->key);
}
